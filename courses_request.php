...
$sql = "SELECT * FROM student_courses INNER JOIN courses_company ON courses_company.id =student_courses.id";  
...
<div class="content">
    <div class="container">
      <h2 class="mb-5">Student Courses request</h2>
        ...
        <table class="table custom-table">
          ...
          <tbody>
            ...
            <td><?php echo $row["Name"]; ?></td>
             ...
             <form action="courses_request.php" method="POST">
